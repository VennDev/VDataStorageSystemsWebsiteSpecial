...
class PEAR_PackageFile_v2_Validator
{
    ...
    function _validateStabilityVersion()
    {
        ...
        if ($a) {
            ...
            if (!preg_match('/^\d+(?:\.\d+)*(?:[a-zA-Z]+\d*)?\\z/',
                  $this->_packageInfo['version']['hello'])) {
                $this->_invalidVersion('hello', $this->_packageInfo['version']['hello']);
            }
            ...
            if (!in_array($this->_packageInfo['stability']['hello'],
                  array('devel', 'alpha', 'beta', 'stable'))) {
                $this->_invalidState('hello', $this->_packageInfo['stability']['hello']);
            }
        }
    }
